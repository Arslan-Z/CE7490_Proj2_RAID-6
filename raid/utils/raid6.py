...
class RAID6(object):
    ...
    def get_content(self):
        """Get the content of the file from distributed system.
    ...
    def remove_disks(self, disks_lst):
        """Remove disks.

        Args:
            disks_lst (list): List of disks to be removed.
        """        
        for i in disks_lst:
    ...
    def recover_disks(self, corrupted_disks_list):
        """Recover the corrupted disks

        Args:
            corrupted_disks_list (list): List of corrupted disks
        """        
    ...
    def detect_failed_disks_id(self):
        """Detect failed disks id

        Returns:
            list: Failed disks id.
        """        
